    ...
    <div ref={rootRef} style={styles.menuBar}>
      <div style={styles.leftArea}>
        ...
        <div style={styles.leftMenus}>
          <div style={styles.menuItemWrapper}>
            <button
              style={menuButtonStyle(openMenu === 'file')}
            ...
            {openMenu === 'file' && (
              <div style={styles.dropdown}>
                ...
                >
                  <span>Reload Keep Entities</span>
                </button>
          ...
          <div style={styles.menuItemWrapper}>
            <button
              style={menuButtonStyle(openMenu === 'scene')}
            ...
            {openMenu === 'scene' && (
              <div style={styles.dropdown}>
                <button style={styles.dropdownItem} onClick={handleClear}>
          ...
          <div style={styles.menuItemWrapper}>
            <button
              style={menuButtonStyle(openMenu === 'engine')}
              ...
              <div style={styles.dropdown}>
                <div style={styles.infoItem}>
                  ...
                  <div
                    style={{
                      ...styles.statusText,
                      color: isExecuting ? '#89d185' : '#cccccc'
                    }}
                  >
          ...
          <div style={styles.menuItemWrapper}>
            <button
              style={menuButtonStyle(openMenu === 'trace')}
              onClick={() => toggleMenu('trace')}
            >
              Trace
            </button>
            ...
            {openMenu === 'trace' && (
              <div style={styles.dropdown}>
                <button
                  style={checkedItemStyle(traceMode === 'off')}
                  onClick={() => handleTraceChange('off')}
                >
                  <span>{traceMode === 'off' ? '✓' : ''}</span>
                  <span>Off</span>
                </button>

                <button
                  style={checkedItemStyle(traceMode === 'basic')}
                  onClick={() => handleTraceChange('basic')}
                >
                  <span>{traceMode === 'basic' ? '✓' : ''}</span>
                  <span>Basic</span>
                </button>

                <button
                  style={checkedItemStyle(traceMode === 'verbose')}
                  onClick={() => handleTraceChange('verbose')}
                >
                  <span>{traceMode === 'verbose' ? '✓' : ''}</span>
                  <span>Verbose</span>
                </button>
              </div>
            )}
          ...
          <div style={styles.menuItemWrapper}>
            <button
              style={menuButtonStyle(openMenu === 'window')}
            ...
            {openMenu === 'window' && (
              <div style={styles.dropdown}>
                <button style={styles.dropdownItem} onClick={closeMenu}>
                  <span>Focus Main View</span>
                </button>
              </div>
            )}
          </div>
      ...
      <div style={styles.rightStatus}>
        <span
          style={{
            ...styles.statusDot,
            backgroundColor: isExecuting ? '#89d185' : '#777'
          }}
        />
        ...
        {isChangingFolder && (
          <span style={styles.muted}>Selecting folder...</span>
        )}
      </div>
    </div>
  )
...
const menuButtonStyle = (active: boolean): React.CSSProperties => ({
  height: 30,
  padding: '0 10px',
  backgroundColor: active ? '#2a2d2e' : 'transparent',
  color: '#cccccc',
  border: 'none',
  outline: 'none',
  cursor: 'pointer',
...
const checkedItemStyle = (checked: boolean): React.CSSProperties => ({
  ...styles.dropdownItem,
  display: 'grid',
